# -*- coding: utf-8 -*-
"""
Created on Mon Mar  9 11:21:13 2020
...
listOfLines =[]
wdf={}
with open("/home/maria_dev/Assignment/Q42_part-r-00000_PH1.txt" , "r") as myfile:
        for line in myfile:
...
for i in range(len(listOfLines)):
        ...
        wdf[key]=fre
dc={}
with open("/home/maria_dev/Assignment/Q42_part-r-00000_PH2.txt", "r") as myfile1:
        for line in myfile1:
                n=line.strip().split('\t')
                dc[n[0]]=n[1]
wd={}
with open("/home/maria_dev/Assignment/Q42_part-r-00000_PH3.txt", "r") as myfile2:
        for line in myfile2:
                n=line.strip().split('\t')
                wd[n[0]]=n[1]
L=list(wd.keys())
...
for i,j in zip(range(len(TFIDF.columns)),range(q)):
        ...
        print("The Top 18 words with highest TFIDF values in the document after eliminating the words with frequency less than 3  " +str(TFIDF.columns[i]) + ' are:' )
